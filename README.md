...
| ファイル | 用途 |
|----------|------|
| [`Requirements_Definition_Document_TEMPLATE.md`](Requirements_Definition_Document_TEMPLATE.md) | 要件定義書テンプレート |
| [`Basic_Design_Document_TEMPLATE.md`](Basic_Design_Document_TEMPLATE.md) | 基本設計書テンプレート |
| [`Detailed_Design_Document_TEMPLATE.md`](Detailed_Design_Document_TEMPLATE.md) | 詳細設計書テンプレート |
| [`design_documents_guide.md`](design_documents_guide.md) | 要件定義・基本設計・詳細設計・仕様書の使い分けガイド |

### 内部仕様書

| ファイル | 用途 |
|----------|------|
| [`TEMPLATE_INTERNAL_SPECIFICATION_BACKEND.md`](TEMPLATE_INTERNAL_SPECIFICATION_BACKEND.md) | バックエンド（サーバー側）内部仕様書 |
| [`TEMPLATE_INTERNAL_SPECIFICATION_FRONTEND.md`](TEMPLATE_INTERNAL_SPECIFICATION_FRONTEND.md) | フロントエンド内部仕様書（UI/UX・状態管理など） |
| [`TEMPLATE_INTERNAL_SPECIFICATION_ANDROID_APP.md`](TEMPLATE_INTERNAL_SPECIFICATION_ANDROID_APP.md) | Android アプリ内部仕様書 |

### 運用・アーキテクチャ・組織

| ファイル | 用途 |
|----------|------|
| [`TEMPLATE_OPERATION.md`](TEMPLATE_OPERATION.md) | 運用手順テンプレート（日常運用・監視・インシデント対応） |
| [`TEMPLATE_ROOT_README.md`](TEMPLATE_ROOT_README.md) | プロジェクトルート用 README テンプレート |
...
├── Requirements_Definition_Document_TEMPLATE.md  # 要件定義書
├── Basic_Design_Document_TEMPLATE.md             # 基本設計書
├── Detailed_Design_Document_TEMPLATE.md          # 詳細設計書
├── design_documents_guide.md                     # 各設計文書の使い分けガイド
├── TEMPLATE_INTERNAL_SPECIFICATION_BACKEND.md    # 内部仕様書（バックエンド）
├── TEMPLATE_INTERNAL_SPECIFICATION_FRONTEND.md   # 内部仕様書（フロントエンド）
├── TEMPLATE_INTERNAL_SPECIFICATION_ANDROID_APP.md# 内部仕様書（Android）
├── TEMPLATE_OPERATION.md                         # 運用手順
├── TEMPLATE_ROOT_README.md                       # プロジェクトREADME
...
4. **運用ドキュメントの整備**
   - 日常運用や監視体制に変更がある場合は [`TEMPLATE_OPERATION.md`](TEMPLATE_OPERATION.md) をベースにした運用ドキュメントを更新し、関連Runbookへのリンクを整備します。
