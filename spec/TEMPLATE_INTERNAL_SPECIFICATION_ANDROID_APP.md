...
> 日常運用手順や監視アラート対応の共通事項は `operation/TEMPLATE_OPERATION.md` をベースにした運用ドキュメントを参照し、本セクションではAndroidアプリ固有の運用観点（ストア運用、リリーストラック、端末サポートなど）を記載してください。
...
- [ ] データ連携・オフライン戦略の記入完了
- [ ] ビルド/リリース手順の記入完了
- [ ] 運用セクションに `operation/TEMPLATE_OPERATION.md` への参照とAndroid固有事項を記載
