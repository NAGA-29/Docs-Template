...
> フロントエンド全体に共通する日常運用やアラート対応は `operation/TEMPLATE_OPERATION.md` を基に作成する運用ドキュメントへ集約し、本セクションではフロントエンド固有のタスクや依存関係のみを記載してください。
...
- [ ] API連携仕様の記入完了
- [ ] テスト方針の記入完了
- [ ] 運用セクションに `operation/TEMPLATE_OPERATION.md` への参照とフロント固有事項を記載
